			...
			<div class="mui-content" style="background: white;">
				<div class="mui-row" style="padding: 13px 0px;">
					...
					<div class="mui-col-xs-5">
						<h4>{{val.title}}</h4>
						<div style="position: relative;">评分：
							<el-rate v-model="(val.rating.average/2).toFixed(1)" disabled show-score text-color="#ff9900" score-template="{value}" style="transform: scale(0.8);width: 120px;overflow: hidden;position: absolute;top:0px;left: 30px;">
...
<script>
	...
	export default {
		...
		created: function() {
			this.$http.get("../../static/top.json").then(function(res) {
